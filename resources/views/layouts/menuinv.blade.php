    ...
    <div style="padding-right:0px; "class="col-md-2">
        <div  class="menu-inv">
            <ul>
                ...
                <li {{ request()->is('escritorioinv') ? 'active' : '' }}><a href="{{route('escritorioinv')}}"><i class="fas fa-home" style="color:blue"></i>   Escritorio</a></li>
                <li {{ request()->is('escritorioinvestigador') ? 'active' : '' }}><a href="{{route('escritorioinvestigador')}}"><i class="far fa-bell" style="color:blue"></i>   Solicitudes</a></li>
                ...
                <li {{ request()->is('vistainvestigaciones') ? 'active' : '' }}><a href="{{route('vistainvestigaciones')}}"><i class="fa fa-folder" style="color:blue"></i>   Investigación</a></li>
                ...
                <li {{ request()->is('resultados') ? 'active' : '' }}><a href="{{route('resultados')}}"><i class="fas fa-chart-pie" style="color:blue"></i>   Resultados</a></li>
